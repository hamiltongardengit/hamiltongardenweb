...
@Component({
    ...
    template: `
        <ng-template #template>
            <svg *ngIf="!fill" width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" [attr.class]="class">
            ...
            <svg *ngIf="fill" width="18" height="18" viewBox="0 0 18 18" fill="none" [attr.class]="class">
